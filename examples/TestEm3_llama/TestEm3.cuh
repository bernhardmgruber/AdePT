...
using Track = llama::Record<llama::Field<RngState, RanluxppDouble>, llama::Field<Energy, double>,
                            llama::Field<NumIALeft, llama::Array<double, 3>>, llama::Field<InitialRange, double>,
...
// using Mapping  = llama::mapping::Trace<llama::mapping::AoS<llama::ArrayExtentsDynamic<int, 1>, Track>, unsigned long long, true>;
